...
import { createInvestment, getInvestmentById, updateInvestment, getUserFunds } from '../../services/api';
import { userId } from '../../App';
import { handleInputChange, handleNumberInputChange, formatCurrency, parseCurrency } from '../../utils/formUtils';
import { validateEmail, validateUrl, validateRequired, validateNumber, validateDate, getValidationError } from '../../utils/validationUtils';
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                ...
                >
                  {editing ? 'Update' : 'Create'} Investment
                </Button>
              </Box>
            </Grid>
          </Grid>
